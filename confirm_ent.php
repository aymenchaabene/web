...
<!--cart-->
	 ...
	 <div class="container">
	  ...
	  {  
		...
		$list=$cc->affiche_off_entr($cc->conn);
			...
			<!--	  <h3 class="h3" style="font-size: 25px " > Vous avez accumulé  <strong  style="color:red" > <php  echo ' <strong> '.$pt.' </strong> ' ?> </strong> <strong>points. </strong></h3> -->
                 ...
                 <a href="valider_off_ent.php?id=<?php echo $l1['id_offre'] ;?> && nom=<?php echo $l1['nom']; ?>"> <input class="buttonoffpt   "  type="button" value="Confirmer "></a>
