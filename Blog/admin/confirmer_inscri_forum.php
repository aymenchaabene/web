...
<form  class="bordure ">
		...
		<center>
                     ...
                     <h3 class="h3" style="font-size: 35px " > <strong >Vous êtes maintenant inscrit au Forum Ben Ghorbel  !</strong></h3> 
                  ...
                  <!--   <h3 class="h3" style="font-size: 35px" > <strong ></strong></h3> -->
  <h3 class="h3" style="font-size: 35px ;color:#026466 " > <strong > Ben Ghorbel Meuble vous remercie pour votre confiance </strong></h3> 
			...
			<a href="insc_forum.php" >  <strong  style="color:white"> ok </strong>  </a>
	  </div>
