...
<!--cart-->
	 ...
	 <div class="container">
	  ...
	  {  
		...
		$list=$cc->affiche_off_surprise($cc->conn);
          ...
          <a href="valider_off_surp.php?id=<?php echo $l1['id_offre'] ;?> && nom=<?php echo $l1['nom']; ?>"> <input class="buttonoffpt   "  type="button" value="Confirmer "></a>       
