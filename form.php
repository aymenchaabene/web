						...
						<form class="form-horizontal" method="POST" action="ajoutVehicule.php">
						  ...
						  <div class="control-group">
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="span6 typeahead" name="gouvernorat"  data-provide="typeahead" data-items="4" required>
							  </div>
							</div>
				...
				foreach ($list as $l) {
				 ...
				 ?>
							  <tr>
								...
								<td class = "center">
									<a class="btn btn-info" href="table.php?id_v=<?php echo $l['id_v'] ?>">
