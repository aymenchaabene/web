...
<head>
	...
	<!-- start: Meta -->
	<meta charset="utf-8">
	<title>Backoffice Ben Ghorbel Meuble</title>
    ...
    var confirmed = confirm("Êtes-vous sûr de vouloir supprimer ce client ?");
   return confirmed;
}
		</script>
	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="index.html"><span>Ben Ghorbel Meuble</span></a>
	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
			  ...
			  <a  href="off.php" >  <input type="submit"  class="btn-mini btn-success"  value="Gestion des offres" ></a>
           
				
				
			<a  href="prop_back.php" >  <input type="submit"  class="btn-mini btn-success"  value="Gestion des propositions" ></a>
             <a  href="chart.php" >  <input type="submit"  class="btn-mini btn-success"  value="Statistiques" ></a>
			   <a  href="pdf/pdf.php" >  <input type="submit"  class="btn-mini btn-success"  value="Génération PDF" ></a>
			<br></br>
		...
		<!--mena bdina -->	
			...
			<div class="row-fluid sortable">		
				...
				<div class="box-content">
					...
					<form method="GET" action="RechercherC.php" >
					<tr>
               <td></td><td><input type="text" name="cin" value="" required placeholder="CIN client..."></td><td> 
				  ...
				  <tr>
						  ...
						  <tbody>
							...
							<td class="center">
									...
									<a class="btn btn-danger" href="supprimerC.php?cin=<?php echo $l1[2] ; ?>" onclick="return confirmAction()"  >
