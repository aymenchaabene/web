...
<!--cart-->
	 ...
	 <div class="container">
		 ...
		 <ul class="megamenu skyblue"> 
			...
			<li><a class="color4" href="#">Gestion du payement</a>
	  ...
	  {  
		...
		$list=$cc->affiche_off_bon_achat($cc->conn);
 ...
 <a href="valider_off_bon_achat.php?id=<?php echo $l1['id_offre'] ;?> && nom=<?php echo $l1['nom']; ?>"> <input class="buttonoffpt   "  type="button" value="Confirmer "></a>
					<a href="index.php"> <input class="buttonoffpt   "  type="button" value="Annuler "></a>
             <br></br> <h3 class="h3" style="font-size: 25px ;color:#026466" > <strong >Ben Ghorbel Meuble vous remercie pour votre fidélité !</strong></h3> 
				<br></br>
	  ...
	  {?>
		  	<center>
				  <h3 class="h3" style="font-size: 25px " > Vous n'avez que  <strong style="color:red" >  <?php  echo ' <strong> '.$pt.' </strong> ' ?>  </strong> <strong>points de fidélité. </strong></h3> 
                     ...
                     <h3 class="h3" style="font-size: 25px " > <strong > Malheureusement ce nombre accumulé ne vous permettriez pas d'acceder à cet offre ! </strong></h3> 
